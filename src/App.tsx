...
import DPHCustomizer from "./pages/Customizers/DPHCustomizer";
import DPVCustomizer from "./pages/Customizers/DPVCustomizer";
import X1HCustomizer from "./pages/Customizers/X1HCustomizer";
import X2HCustomizer from "./pages/Customizers/X2HCustomizer";
import X2VCustomizer from "./pages/Customizers/X2VCustomizer";
import X1VCustomizer from "./pages/Customizers/X1VCustomizer";
import IDPGCustomizer from "./pages/Customizers/IDPGCustomizer";
import IDPG_RNCustomizer from "./pages/Customizers/IDPG_RNCustomizer";
