      ...
      if (!isEditMode && location.state?.selectedDesignId) {
        try {
          ...
          if (designData && !error) {
            ...
            console.log('🔍 Proximity flag check:', proximityFlag);
            
            if (proximityFlag === true) {
              console.log('✅ Proximity flag is true - showing proximity indicators');
              setShowProximityIndicators(true);
              // Persist in panelDesign for previews and saved design
                ...
                >
                  ...
                  <div style={{ position: 'relative', zIndex: 2, width: '100%', height: '100%', transform: `translate(${gridOffsetX}px, ${gridOffsetY}px)` }}>
                    {Array.from({ length: 9 }).map((_, index) => {
                      // Debug logging for position 0
                      if (index === 0) {
                        console.log(`🔍 SPCustomizer Position 0:`, {
                          pos: activeIconPositions[0],
                          gridOffsetX,
                          gridOffsetY,
                          dimensionKey,
                          activeDimension,
                      ...
                      return renderAbsoluteCell(index);
                    })}
                </div>
              </div>
